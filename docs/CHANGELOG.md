...
### Исправление наложения виджетов и синхронная регистрация реестра
...
2. **Алгоритм предотвращения и разрешения коллизий на сетке (`findFirstAvailablePosition`, `resolveLayoutCollisions`):**
   ...
   - В `ResponsiveGridLayout` включены параметры `compactType="vertical"` и `preventCollision={false}`, обеспечивающие автоматическое вытеснение/смещение нижележащих виджетов при Drag & Drop и Resize.
